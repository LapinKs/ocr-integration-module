from app.infrastructure.merge.deprecated.domain.page import Page
from app.infrastructure.merge.deprecated.domain.line import Line
from app.infrastructure.merge.deprecated.domain.word import Word
